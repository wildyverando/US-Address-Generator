...
def generate_random_address(city_data, existing_addresses):
    ...
    while True:
        ...
        full_address = f"{street_number} {street_name}, {city}, New Hampshire {zipcode}"
...
for _ in range(num_addresses):
    ...
    database[0]["data"]["NH"].append(random_address)
