...
srcdata = [
    {
        ...
        "data": [
            ...
            },
            {
                "city": "Canon",
                "phone": "(706) 245",
                "address": ["Airline Goldmine Rd"],
                "zipcode": ["30520"]
            },
            {
                "city": "Royston",
                "phone": "(762) 338",
                "address": ["Nails Creek Rd"],
                "zipcode": ["30662"]
            }
        ]
    }
...
def generate_random_address(city_data, existing_addresses):
    ...
    while True:
        ...
        full_address = f"{street_number} {street_name}, {city}, Georgia {zipcode}"
...
for _ in range(num_addresses):
    ...
    database[0]["data"]["GA"].append(random_address)
